...
var _svgInjector = __webpack_require__(3);

var _svgInjector2 = _interopRequireDefault(_svgInjector);

var _InteractiveMap = __webpack_require__(4);
...
var App = function () {
    ...
    _createClass(App, null, [{
        ...
        value: function init(options) {
            var mapSVGPath = options.mapSVGPath;

            var mapConfig = options.maps || [];
...
var _StateLookup = __webpack_require__(9);

var _StateLookup2 = _interopRequireDefault(_StateLookup);
...
function validateOptions(options) {
    ...
    if (!_lodash.isString || !options.id.length) {
        errors.push("Map options require an 'id'");
    }

    var validateKeys = function validateKeys(opts, valid) {
...
var InteractiveMap = function () {
    function InteractiveMap(options) {
        ...
        this.styles = (0, _lodash.defaults)(this.options.styles, DEFAULT_STYLES);

        this.dom = new _DOM2.default(this.options.id);
    ...
    _createClass(InteractiveMap, [{
        ...
        value: function mount() {
            ...
            this.dom.states.forEach(function (state) {
                var disabled = _this.options.disabledStates.indexOf(state.id) !== -1;

                if (disabled) {
                    _this.setupDisabledStyles(state);
                } else {
                    _this.bindHoverStyles(state);
                    _this.setupStyles(state);
                    _this.bindCallbacks(state);
                }
            });
        }
    }, {
        key: "bindCallbacks",
        value: function bindCallbacks(state) {
            var callbackLookup = this.getCallbackLookup();

            (0, _lodash.forOwn)(callbackLookup, function (handler, onevent) {
                state.addEventListener(onevent, handler);
            });
        }
    }, {
        key: "bindHoverStyles",
        value: function bindHoverStyles(state) {
            var _this2 = this;

            window.thing = state;

            state.addEventListener("mouseenter", function () {
                state.style.fill = _this2.styles.stateHoverFill;
            });

            state.addEventListener("mouseout", function () {
                state.style.fill = _this2.styles.stateFill;
            });
        }
    }, {
        key: "getCallbackLookup",
        value: function getCallbackLookup() {
            var _this3 = this;

            var callbackLookup = {};

            if (this.options.linkTo.length) {
                callbackLookup.click = function (e) {
                    window.location.href = _this3.getLink(e.target.id);
                };
            }
        ...
        key: "getLink",
        value: function getLink(stateAbbrev) {
            var stateName = _StateLookup2.default[stateAbbrev];
        ...
        key: "setupStyles",
        value: function setupStyles(state) {
            state.style.fill = this.styles.stateFill;
            state.style.cursor = "pointer";
        }
    }, {
        key: "setupDisabledStyles",
        value: function setupDisabledStyles(state) {
...
var DOM = function () {
    ...
    _createClass(DOM, [{
        key: "setDataSource",
        value: function setDataSource(path) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=usa-map.js.map